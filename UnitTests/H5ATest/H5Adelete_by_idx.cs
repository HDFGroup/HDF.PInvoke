    ...
    public partial class H5ATest
    {
        ...
        public void H5Adelete_by_idxTest1()
        {
            ...
            Assert.IsTrue(H5A.delete_by_idx(m_v0_test_file, ".",
                H5.index_t.H5_INDEX_NAME,
                H5.iter_order_t.H5_ITER_NATIVE, 0) >= 0);
            Assert.IsTrue(H5A.delete_by_idx(m_v0_test_file, ".",
                H5.index_t.H5_INDEX_NAME,
                H5.iter_order_t.H5_ITER_NATIVE, 0) >= 0);
            ...
            Assert.IsTrue(H5A.delete_by_idx(m_v2_test_file, ".",
                H5.index_t.H5_INDEX_NAME,
                H5.iter_order_t.H5_ITER_NATIVE, 1) >= 0);
            Assert.IsTrue(H5A.delete_by_idx(m_v2_test_file, ".",
                H5.index_t.H5_INDEX_NAME,
                H5.iter_order_t.H5_ITER_NATIVE, 0) >= 0);
        }
        ...
        public void H5Adelete_by_idxTest2()
        {
            Assert.IsFalse(
                ...
                H5.index_t.H5_INDEX_NAME, H5.iter_order_t.H5_ITER_NATIVE, 10)
                >= 0);
            Assert.IsFalse(
                H5A.delete_by_idx(m_v0_class_file, ".",
                H5.index_t.H5_INDEX_NAME, H5.iter_order_t.H5_ITER_NATIVE, 1024)
                >= 0);
        }
    }
}